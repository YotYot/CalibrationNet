...
class nyu_depth_segmentation_dataset(data.Dataset):
            ...
            if load_pickle:
                ...
                for patch in os.listdir(train_dir):
                    if patch.endswith('.png'):
                        ...
                        base = patch.split('_')[0] +'_'+ patch.split('_')[1] + '_GT'
                        label = base + '.png'
...
if __name__ == '__main__':
    print ("A")
    mv_30_percent_for_testing(train_dir='/home/yotamg/imaging/output_D25_Dn2150/rgb', test_dir='/home/yotamg/imaging/output_D25_Dn2150/rgb/test')
